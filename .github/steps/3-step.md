...
1. 次のコメントを入力し、**Submit review** ボタンをクリックします。
   ...
   <img width="300" alt="Submit review ボタン" src="https://github.com/K-dev-oss/skills-review-pull-requests/blob/main/.github/images/submit-review-button.png?raw=true" />
